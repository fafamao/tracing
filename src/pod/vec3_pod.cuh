...
__device__ inline float length_squared(const Vec3 &v) {
  return v.x * v.x + v.y * v.y + v.z * v.z;
}

// Vector length
__device__ inline float length(const Vec3 &v) {
...
__device__ inline Vec3 operator*(const Vec3 &v, float t) { return t * v; }

// Scalar division
__device__ inline Vec3 operator/(const Vec3 &v, float t) { return (1 / t) * v; }
...
// Get a unit vector
__device__ inline Vec3 unit_vector(const Vec3 &v) { return v / length(v); }
